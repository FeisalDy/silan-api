			...
			Translations: []novel.NovelTranslation{
				{
					...
					Summary:     strPtr("Cultivation journey from weak to strong"),
				},
				{
					Lang:        "id",
					...
					Summary:     strPtr("Perjalanan kultivasi dari lemah menjadi kuat"),
				},
			},
			...
			Translations: []novel.NovelTranslation{
				{
					...
					Summary:     strPtr("Isekai reincarnation with game mechanics"),
				},
				{
					Lang:        "id",
					...
					Summary:     strPtr("Reinkarnasi isekai dengan mekanik game"),
				},
			},
			...
			Translations: []novel.NovelTranslation{
				{
					...
					Summary:     strPtr("Dungeon hunter rises from weakest to strongest"),
				},
				{
					Lang:        "id",
					Title:       "Raja Bayangan",
					...
					Summary:     strPtr("Pemburu dungeon bangkit dari terlemah menjadi terkuat"),
				},
			},
